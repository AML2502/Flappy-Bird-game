...
alert("This is FLAPPY BIRD GAME hope you enjoy playing");
//background
bg = createSprite(144,256,10,10);
bg.addImage(bg_image);
line = createSprite(200,40,500,6);
line.shapeColor=(112,197,206);
line.visible=false;
//foot ground
...
if(fg.x < 137){
  ...
  //game end
  if (bird.isTouching(pipe1Group) || bird.isTouching(pipe2Group)|| bird.isTouching(line)){
    gameState = END;
  }
